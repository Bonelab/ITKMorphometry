 ...
 *
 *=========================================================================*/
#ifndef itkDiracDeltaImageFilter_hxx
#define itkDiracDeltaImageFilter_hxx
...
DiracDeltaImageFilter<TInputImage, TOutputImage>
...
::DynamicThreadedGenerateData(const OutputRegionType & outputRegion)
{
  ...
  switch(this->GetApproximation()) {
    case SmoothApproximationType::Tanh: approx_function = &dirac_delta_tanh<RealType>; break;
    case SmoothApproximationType::Sin: approx_function = &dirac_delta_sin<RealType>; break;
...
#endif // itkDiracDeltaImageFilter_hxx
