...
norm run_value(double h, double radius)
{
  ...
  correct->SetMaxIteration(15);
  // correct->SetNarrowbandSize(15.);
  correct->SetMaxError(0.);
  correct->Update();

  writer->SetFileName("correct_h1.nii");
...
int main(int argc, char * argv[])
{
  ...
  std::vector<double> hs {1.};//{8., 4., 2., 1., 0.5, 0.25, 0.125};//{8., 4., 2., 1.};//{8., 4., 2., 1., 0.5};// {2., 1., 0.5, 0.25};//{8., 4., 2., 1.};//0.25};//{2.0, 1.0, 0.5, 0.25};
  for(double &h: hs)
  {
