...
// using BinType = itk::SignedFastMarchingImageFilter< OutputImageType >;
using BinType = itk::SmoothBinarySurfaceImageFilter< OutputImageType >;
...
int main(int argc, char * argv[])
{
  ...
  BinType::Pointer fitler = BinType::New();
